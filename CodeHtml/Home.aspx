<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="CodeHtml.Home" %>
                ...
                <tr>
                    <td>
                        <asp:Button ID="Button1" runat="server" CssClass="btnmenu" Text="Home"
                            PostBackUrl="~/Home.aspx" OnClick="Button1_Click" />
                    </td>
                    <td class="style2">
                    ...
                    <td>
                        <asp:Button ID="Button5" runat="server" CssClass="btnmenu" Text="Admin Panel"
                            PostBackUrl="~/Admin/Home.aspx" OnClick="Button5_Click" />
                    </td>
                    <td>
        ...
        <div id="mainn">
                    ...
                    <table class="style3">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <%--<asp:TextBox ID="txtstuuname" runat="server" CssClass="txt" OnTextChanged="txtstuuname_TextChanged"></asp:TextBox>--%>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <asp:Button ID="btnstudenlogin" runat="server" CssClass="btn" Text="Login" OnClick="btnstudenlogin_Click" />
            ...
            <div id="right">
                <div id="wowslider-container1">
                    <div class="ws_images">
                        <a href="#">
                            <img src="data1/images/479706089.jpg" alt="" title="" id="wows0" /></a>
                        <a href="#">
                            <img src="data1/images/blogimagehandraise2_1.jpg" alt="" title="" id="wows1" /></a>
                        <a href="#">
                            <img src="data1/images/phreassignmentsfaq.jpg" alt="" title="" id="wows2" /></a>
                    </div>
                    <div class="ws_bullets">
                        <div>
                            <a href="#wows0" title="">
                                <img src="data1/tooltips/479706089.jpg" alt="" />1</a>
                            <a href="#wows1" title="">
                                <img src="data1/tooltips/blogimagehandraise2_1.jpg" alt="" />2</a>
                            <a href="#wows2" title="">
                                <img src="data1/tooltips/phreassignmentsfaq.jpg" alt="" />3</a>
                        </div>
                    </div>
