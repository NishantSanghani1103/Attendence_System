<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.Master" AutoEventWireup="true" CodeBehind="Leave.aspx.cs" Inherits="CodeHtml.Student.Leave" %>
                                                ...
                                                <asp:GridView ID="GridView1"  BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Days">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("NoDays") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
