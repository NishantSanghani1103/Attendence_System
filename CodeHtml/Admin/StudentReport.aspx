<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="StudentReport.aspx.cs" Inherits="CodeHtml.Admin.StudentReport1" %>
        ...
        <td>
            <table align="left" class="style4">
                <tr>
                    ...
                    <td class="style6">
                        <asp:DropDownList ID="drpstd" CssClass="txt" AutoPostBack="true"  runat="server"></asp:DropDownList>
                        <%--<asp:DropDownList ID="drpstd" CssClass="txt" AutoPostBack="true"  runat="server"></asp:DropDownList>--%>
                ...
                <tr>
                    ...
                    <td class="style6">
                        <asp:DropDownList ID="drpdiv" CssClass="txt" AutoPostBack="True"  runat="server"></asp:DropDownList>
                         <%--<asp:DropDownList ID="drpdiv" runat="server" CssClass="txt" AutoPostBack="True" OnSelectedIndexChanged="drpdiv_SelectedIndexChanged"></asp:DropDownList>--%>
                        <%--<asp:DropDownList ID="drpdiv" runat="server" CssClass="txt" AutoPostBack="True" 
                            onselectedindexchanged="drpdiv_SelectedIndexChanged"></asp:DropDownList>--%>
                        <%--<asp:DropDownList ID="drpdiv" runat="server" CssClass="txt" AutoPostBack="True" 
                ...
                <tr>
                    ...
                    <td class="style6">
                        <asp:DropDownList ID="drpstudent" runat="server" CssClass="txt"></asp:DropDownList>
                        <%--<asp:DropDownList ID="drpstudent" runat="server" CssClass="txt">
                        </asp:DropDownList>--%>
                    </td>
                    <td class="style5" valign="bottom">
                        <asp:Button ID="btnsarch" runat="server" CssClass="btn" Text="Select" OnClick="btnsarch_Click" />
